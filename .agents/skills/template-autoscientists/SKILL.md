...
author: docxology
license: MIT
tags: [exemplar, coordination, agents, ablation]
---
...
uv run python scripts/02_run_analysis.py --project templates/template_autoscientists
uv run python scripts/03_render_pdf.py --project templates/template_autoscientists
